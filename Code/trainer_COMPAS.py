...
dataset_names = ['COMPAS'] #COMPAS or Adult

# Model architecture
n_layers = 2 # MLP-hidden layer
n_hidden_units = 128 # MLP-hidden node
...
lambda_ = 0.9 # Fairness regularization coefficient from [0, 1]

# DRO hyperparameter
reg_strength = 10 # Distributional robustness regularization coefficient from [0, +inf]
...
print_log = open("log_COMPAS.txt","w")
